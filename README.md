...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=734&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/oslo.serialization-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `oslo.serialization` can be installed with `conda`:
...
```
mamba install oslo.serialization
```

It is possible to list all of the versions of `oslo.serialization` available on your platform with `conda`:
...
```
mamba search oslo.serialization --channel conda-forge
```
...
mamba repoquery search oslo.serialization --channel conda-forge

# List packages depending on `oslo.serialization`:
mamba repoquery whoneeds oslo.serialization --channel conda-forge

# List dependencies of `oslo.serialization`:
mamba repoquery depends oslo.serialization --channel conda-forge
```
